...
import org.mddarr.ride.coordinate.service.mock.CustomKafkaAvroDeserializer;
...
@SpringBootTest(classes = {RideCoordinateApplication.class}, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
